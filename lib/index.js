...
var engine = require('engine.io-legacy');
// var client = require('socket.io-client-legacy');
// var clientVersion = require('socket.io-client-legacy/package.json').version;
var Client = require('./client');
var Namespace = require('./namespace');
var Adapter = require('socket.io-adapter-legacy');
...
// var clientSource = read(require.resolve('socket.io-client-legacy/socket.io.js'), 'utf-8');
